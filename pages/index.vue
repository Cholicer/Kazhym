...
const selectedStatus = ref("Барлығы");
...
const selectFilter = computed(() => {
	return dataStore.data.filter(item => {
		if (selectedStatus.value === "Барлығы") {
			return item;
		}
...
<template>
	<div class="w-full h-full flex flex-col">
		...
		>
			<div
				class="scroll-bar w-[90%] lg:w-[55%] lg:h-full mx-auto md:mt-5 md:ml-7 pl-3 flex flex-col text-white overflow-y-auto"
			>
				<h1 class="text-2xl">Тапсырмалар</h1>
