...
<template>
	...
	>
		...
		<div
			v-if="info"
			class="group/item bg-[#121212] border border-dotted rounded-xl invisible text-gray-200 px-2 py-1 absolute bottom-0 right-1 group-hover:visible group-hover:-translate-y-11 group-hover:ease-in"
		>
